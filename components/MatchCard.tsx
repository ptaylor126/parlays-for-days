...
function TeamLogo({ teamName, logo, needsWhiteBg }: { teamName: string; logo: string; needsWhiteBg: boolean }) {
  ...
  // For all badges (including non-circular), use a flexible container
  // that allows the badge to display fully without cropping
  // Use a larger max size to accommodate non-circular badges like shields
  return (
    <div
    ...
    >
      ...
      <div className="space-y-2.5">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center" style={{ minWidth: 32, minHeight: 32 }}>
            <TeamLogo 
